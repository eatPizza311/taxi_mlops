...
@click.command()
@click.option("--train_path", help="Location where the training data is.")
@click.option("--val_path", help="Location where the validation data is.")
def main_flow(train_path: str, val_path: str):
    ...
    # Transform
    X_train, y_train, X_val, y_val, dv = add_features(df_train, df_val)

    # Train
    train_best_model(X_train, y_train, X_val, y_val, dv)
